...
var ServiceWorkerUpdater = function ServiceWorkerUpdater(setUpdateHandler, _ref) {
  ...
  var _ref$checkInterval = _ref.checkInterval,
      ...
      updateOnLoad = _ref$updateOnLoad === void 0 ? true : _ref$updateOnLoad;

  _defineProperty(this, "updateInterval", null);

  _defineProperty(this, "registerServiceWorker", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
    var reg;
...
export { ServiceWorkerUpdater as default };
